const Meredith = {
  ...
  <div class="bgBlue center comicsans">
    <div class="wrapper">
      ...
      <p>
        Fight to end rabies. Every <span class="strike">mile</span> kilometer
        matters in the fight for our lives. For our freedom. Against the
        rabid oppressor, death itself. Free Meredith Palmer from her cage of
        disease and let her run wild like the free animal she is. Won’t you
        join us?
      </p>
      <h2>Sponsors</h2>
      <ul>
