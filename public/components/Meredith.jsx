...
var Meredith = Vue.extend({
    render: function (h) {
        console.log("rendering");
        return (<div class="bgBlue center comicsans">
        <div class="wrapper">
          <p>
            <img src="/static/michaelscottsdundermifflinscrantonmeredithpalmermemorialcelebrityrabiesawarenessproamfunrunraceforthecure.gif" alt="Michael Scott’s Dunder Mifflin Scranton Meredith Palmer Memorial Celebrity Rabies Awareness Pro-Am Fun Run Race For The Cure"/>
          </p>
          <p>
          ...
          <p>
            <figure>
              <img src="/static/carboload.gif" alt="Fun run brought to you by Giovanni’s alfredo"/>
            </figure>
          </p>
          <p>
            <router-link to="/">
